    ...
    <div class="nk-sidebar-bar">
        <div class="nk-apps-brand">
            <a href="/office" class="logo-link">
                <img class="logo-light logo-img" src="{{ asset('Admin/images/logo-g.png') }}" srcset="{{ asset('Admin/images/logo-g.png 2x') }}" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('Admin/images/logo-g.png') }}" srcset="{{ asset('Admin/images/logo-g.png 2x') }}" alt="logo-dark">
            </a>
        </div>
                        ...
                        <ul class="nk-menu apps-menu">
                            <li class="nk-menu-item">
                                <a href="#" class="nk-menu-link nk-menu-switch" data-target="navPharmacy">
                                    <span class="nk-menu-icon"><i class="fa fa-table" aria-hidden="true"></i></span>
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="#" class="nk-menu-link nk-menu-switch" data-target="navHospital">
                                    <span class="nk-menu-icon"><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>
                                </a>
                            </li>
                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="{{ route('petugas') }}" class="nk-menu-link">
                            <span class="nk-menu-icon"><i class="fa fa-users" aria-hidden="true"></i></span>
